...
# The new data base will be only the URLS of this papers: theguardian.com, standard.co.uk, dailymail.co.uk
df_clean = df[(df["media_url"] == "theguardian.com") |( df["media_url"] == "standard.co.uk") | (df["media_url"] == "dailymail.co.uk") ]
